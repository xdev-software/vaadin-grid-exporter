...
/**
 * Styles for the {@link GridExportDialog}
 *
 * @author Johannes Rabauer
 */
public interface GridExporterStyles
{
	...
	String HTML_PREVIEW = "grid-exporter-html-preview";
	String COLUMN_GRID = "grid-exporter-column-grid";
}
